...
class SpotifyService {
    static exchange() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!Settings_1.Settings.credentials.clientID || !Settings_1.Settings.credentials.clientSecret || !Settings_1.Settings.credentials.code)
                return;
            const redirectUri = Settings_1.Settings.credentials.customRedirectUri || "http://127.0.0.1:8999/callback";
    ...
    static refresh() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!Settings_1.Settings.credentials.clientID || !Settings_1.Settings.credentials.clientSecret || !Settings_1.Settings.credentials.refreshToken)
                return;
            const redirectUri = Settings_1.Settings.credentials.customRedirectUri || "http://127.0.0.1:8999/callback";
            const request = yield fetch("https://accounts.spotify.com/api/token", {
                "headers": {
