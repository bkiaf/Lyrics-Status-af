...
class SpotifySource extends BaseSource_1.BaseSource {
    ...
    getLyrics(name, artist, trackId = "") {
        return __awaiter(this, void 0, void 0, function* () {
            const songId = trackId || (yield this.getSongId());
            if (!songId)
                throw "No Spotify track id";
            ...
            if (!request.ok)
                throw "Lyrics request failed";
            const json = yield request.json();
            if (!json.lyrics || json.lyrics.showUpsell || json.lyrics.syncType === "UNSYNCED")
